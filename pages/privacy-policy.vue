    ...
    <div>
            ...
            <div class="row">
              <div class="col-lg-7 d-flex justify-content-center flex-column">
                ...
                <p class="lead pe-sm-5 me-sm-5 text-white opacity-8">
                  Know How we collect, use, and share your personal data.
                </p>

                <!-- Start:Date -->
                <div class="text-white">
                  In Action since:<strong class="ms-2">4-Feb-2022</strong>
                </div>
                <!-- End:Date -->
              </div>
            </div>
      ...
      <div class="card card-body shadow-xl mx-3 mx-md-4 mt-n6">
        <section class="py-5 mt-5">
          <div class="container">
            <div class="row">
              <div class="col-lg-9 ms-auto me-auto" id="postContent">
                <div>
                  <h1>Privacy Policy for Inforum</h1>
                  ...
                  <p>
                    ...
                    information that they shared and/or collect in koka.com.
                  ...
                  <p>
                    <span class="text-info text-bold">Inforum</span> follows a
                    standard procedure of using log files. These files log
                    visitors when they visit websites. All hosting companies do
                  ...
                  <p>
                    Like any other website, koka.com uses 'cookies'. These
                  ...
                  <p>
                    <span class="text-info text-bold">Inforum's</span> Privacy
                    Policy does not apply to other advertisers or websites.
                  ...
                  <p>
                    <span class="text-info text-bold">Inforum</span> does not

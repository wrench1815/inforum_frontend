  ...
  <div>
    ...
    <div class="container-fluid py-4">
      <div class="card py-4">
        <div class="row">
          <div class="col-12">
            <h2 class="mx-4">Add Sub Answer</h2>
  ...
  methods: {
    ...
    async addForm() {
      if (this.loggedInUserRole == 'Admin') {
        const data = {
          answer: this.answer,
          queryAnswerId: this.$route.params.id,
          userId: this.loggedInUser.id,
        }

        await this.$axios
          .$post('/ForumSubAnswers', data)
          .then((res) => {
            if (res.status == 201) {
              let timerInterval
              ...
              this.$swal({
                title: 'Success!',
                html: 'Sub Answer added successfully. <br /> Redirecting in <b></b> Seconds.',
                type: 'success',
                icon: 'success',
                timer: 2000,
                ...
                this.$router.push(
                  `/admin/forum/answers/subanswers/${this.$route.params.id}`
                )
              })
            }
          })
          .catch((err) => {
            ...
            try {
              ...
              msg = 'Unable to create sub answer.<br/>Please Try Again Later.'
            }

  ...
  <div>
    ...
    <div class="container-fluid py-4">
      ...
      <div class="card py-4" v-if="!loading">
        <div class="row">
          <div class="col-12">
            <h2 class="mx-4 pb-3">Query Answers</h2>
          </div>
          <div class="col-12 text-center" v-if="answers.length == 0">
            <img
              ...
              v-lazy-load
            />
            <h3 class="mx-4">No Answers Yet</h3>
          </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr class="text-primary text-center text-md">
                      ...
                      <th class="text-uppercase">Sub Answers</th>
                    ...
                    >
                      ...
                      >
                        <NuxtLink
                          ...
                          :to="`/admin/forum/answers/preview/${answer.id}`"
                      ...
                      <td class="text-center">
                        <NuxtLink
                          :to="`/admin/forum/answers/subanswers/${answer.id}`"
                        >
                      ...
                      <td>
                        <div class="d-flex justify-content-evenly">
                          <NuxtLink
                            :to="`/admin/forum/answers/edit/${answer.id}`"
                          >
          ...
          <div class="col-12">
            <div class="d-flex justify-content-end mx-4">
              <NuxtLink
                ...
                :to="`/admin/forum/answers/add/${this.$route.params.id}`"
                >Add Answer</NuxtLink
              >
            </div>
          </div>
  ...
  methods: {
    getData(pageNumber) {
      const answers = this.$axios.$get(
        `/ForumAnswer?PageNumber=${pageNumber}&PageSize=${this.pageSize}&queryId=${this.$route.params.id}`
      )
      ...
      answers
        ...
        .catch((error) => {
          ...
          try {
            ...
            msg = 'Unable to load Answers <br/>Refresh Page to try Again.'
          }
      ...
      customAlert
        ...
        .then(async (result) => {
          if (result.isConfirmed) {
            await this.$axios.$delete(`/ForumAnswer/${id}`)
            this.$swal.fire({
              icon: 'success',
              title: 'Item Deleted',

...
export default {
  ...
  data() {
    return {
      ...
      plugins:
        'lists link image paste help wordcount autolink autosave codesample fullscreen hr table textpattern media',
      toolbar:
        'undo redo | formatselect | bold italic link | image media table | bullist numlist hr | codesample fullscreen | help',
